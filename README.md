...
| 項目 | 内容 |
|---|---|
| 天気 | 日本語の天気（快晴 / 晴れ / 曇り / 小雨 / 雨 / 雪 / 雷雨 など。WMO天気コードを日本語化、[後述](#雨の強さの表しかた)） |
| 気温 | 摂氏（℃） |
| 湿度 | 相対湿度（%） |
...
**「天気」は日中（6〜18時）から決めています。** Open-Meteo の日別 `weather_code` は24時間の最大値なので、未明に1時間だけ弱い雨があると、日中ずっと晴れの日でもその雨が「その日の天気」になってしまいます。そこでこの拡張では日別の値をそのまま使わず、**時間別の天気コードから日中だけを見て**次のように決めています。

| | 扱い |
|---|---|
| 雨・にわか雨・雪・にわか雪・雷雨・着氷性の雨など | **1時間でも出たら採用**（短い雷雨を見逃さないため） |
| 小雨・弱い雨・霧 | **2時間以上続いたときだけ採用** |
| 上のどれもなければ | 快晴／晴れ／晴れ（雲多め）／曇り のうち、**2時間以上続いたもの**でいちばん曇っているもの |

> 例1（東京 100-0001 / 2026-08-06 の実データ）: 未明の 00〜07時に弱い雨があり、08〜23時はずっと晴れ〜快晴で降水 0.0mm。日別 `weather_code` をそのまま使うと「弱い雨」ですが、このブロックは「晴れ（雲多め）」を返します（気象庁の同日の予報は「くもり時々晴れ」）。
>
