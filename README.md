...
| 項目 | 内容 |
|---|---|
| 天気 | その日でもっとも強い天気（[後述](#週間予報の天気と降水確率の読みかた)） |
| 最高気温 | 摂氏（℃） |
| 最低気温 | 摂氏（℃） |
...
**「天気」は、その日の“代表的な”天気ではなく“もっとも強い”天気です。** Open-Meteo の日別 `weather_code` は、その日の時間別コードの最大値です。1時間でも弱い霧雨が混じると、ほとんど晴れの日でも「霧雨」になります。

> 例（東京 100-0001 / 2026-08-07 の実データ）: 天気は「霧雨」ですが、日照時間は 11.3 時間（可照時間 13.8 時間の 82%）、降水量は 3.7 mm です。日中はよく晴れていて、そこに弱い霧雨が挟まっている、という日です。

より実感に近い天気を知りたいときは、時間別ブロックで見たい時刻の天気を直接調べるのがおすすめです。
...
> 例（大阪 530-0001 / 2026-08-07 の実データ）: 天気「晴れ」・降水量 0 mm・降水確率 67%
