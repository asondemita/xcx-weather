...
**採用したい天気が1日に複数あるときは、いちばん激しい時間を代表にします。** 同じ激しさのものが並んだときは、長く続いたほうを選びます。たとえば「強い雨が4時間＋にわか雨（弱）が1時間」の日は「雨（強）」、「雨が4時間＋にわか雨が1時間」の日は「雨」です。雷雨はどれよりも優先されるので、1時間しかなくても必ず「雷雨」になります。
