...
| 霧雨・霧 | **2時間以上続いたときだけ採用** |
| 上のどれもなければ | 快晴／晴れ／晴れ時々曇り／曇り のうちもっとも曇っているもの |

> 例（東京 100-0001 / 2026-08-06 の実データ）: 未明の 00〜07時に弱い霧雨があり、08〜23時はずっと晴れ〜快晴で降水 0.0mm。日別 `weather_code` は「霧雨」ですが、このブロックは「曇り」を返します（気象庁の同日の予報は「くもり時々晴れ」）。

より細かく知りたいときは、時間別ブロックで見たい時刻の天気を直接調べるのが確実です。

**「降水確率」だけは、ほかの項目と別のモデル由来です。** 日本付近では気温・降水量・天気は気象庁（JMA）のモデルから来ますが、JMA は降水確率を配信していないため、Open-Meteo は降水確率だけをアンサンブル系の別モデルで補完しています。そのため次のような組み合わせが普通に起こります。

> 例（大阪 530-0001 / 2026-08-07 の実データ）: 天気「晴れ」・降水量 0 mm・降水確率 67%（気象庁の同日の降水確率は 20%）

降水確率は日中に絞っても気象庁には近づきません（地点によってはむしろ離れます）。定義が違う別の量だと思って使ってください。
